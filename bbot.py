...
NAWAWI_HADITHS = {
    ...
    "3️⃣1️ 31. Не презирай себя": "📖 Пророк (ﷺ) сказал:\n\n«Не презирай себя».\n\n(Ибн Маджа 4217)\n\n💡 **Пояснение:**\nНе унижай себя перед людьми.",
    
    "3️2️⃣ 32. Вред и польза": "📖 Пророк (ﷺ) сказал:\n\n«Поистине, вред и польза — только от Аллаха».\n\n(Тирмизи 2516)\n\n **Пояснение:**\nВсё в руках Аллаха.",
