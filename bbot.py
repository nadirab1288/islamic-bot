...
REMINDERS = [
    ...
    "🕌 Пророк () сказал: «Не войдёт в Рай тот, чей сосед не находится в безопасности от его зла».\n(Бухари 6016)",
    "🕌 Пророк (ﷺ) сказал: «Каждый из вас — пастырь, и каждый несёт ответственность за свою паству».\n(Бухари 893)",
    "🕌 Пророк () сказал: «Верующий для верующего — как здание, части которого укрепляют друг друга».\n(Бухари 2446)",
    "🕌 Пророк () сказал: «Самое любимое дело пред Аллахом — постоянное, даже если оно мало».\n(Бухари 6464)",
    ...
    "🕌 Пророк () сказал: «Аллах прекрасен и любит красоту».\n(Муслим 91)",
    "🕌 Пророк () сказал: «Тот, кто накормит голодного мусульманина, тому Аллах построит дом в Раю».\n(Тирмизи 2362)",
    ...
    "🕌 Пророк (ﷺ) сказал: «Кто скажет утром и вечером \"СубханАллахи ва бихамдихи\" 100 раз...».\n(Муслим 2692)",
    "🕌 Пророк () сказал: «Кто прочитает суру \"Аль-Кахф\" в пятницу, тому засветит свет между двумя пятницами».\n(Хаким)",
...
DAILY_CONTENT = [
    ...
    {"type": "hadith", "text": "🕌 Пророк () сказал: «Вера имеет более 70 ответвлений. Самое высокое — Шахада, самое низкое — удаление препятствия с дороги».\n(Муслим 35)", "title": "Хадис дня"},
    ...
    {"type": "hadith", "text": "🕌 Пророк (ﷺ) сказал: «Распространяйте мир, кормите голодных, молитесь ночью — и войдёте в Рай с миром».\n(Тирмизи 1855)", "title": "Хадис дня"},
    ...
    {"type": "hadith", "text": " Пророк (ﷺ) сказал: «Тот, кто не благодарит людей, не благодарит Аллаха».\n(Абу Дауд 4811)", "title": "Хадис дня"},
    ...
    {"type": "hadith", "text": "🕌 Пророк () сказал: «Рука дающая лучше руки берущей».\n(Бухари 1429)", "title": "Хадис дня"},
    ...
    {"type": "hadith", "text": "🕌 Пророк () сказал: «Не завидуйте, не завышайте цены, не ненавидьте... будьте братьями».\n(Муслим 2564)", "title": "Хадис дня"},
...
DUAS = {
    ...
    "📿 После азана": "اللَّهُمَّ رَبَّ هَذِهِ الدَّعْوَةِ التَّامَّةِ وَالصَّلَاةِ الْقَائِمَةِ آتِ مُحَمَّدًا الْوَسِيلَةَ وَالْفَضِيلَةَ\n«Аллахумма рабба хазихи ад-да'вати ат-таммати ва-с-салати аль-қа'имати, ати Мухаммадан аль-василата ва-ль-фадилата»\n(О Аллах, Господь этого совершенного призыва и предстоящей молитвы, даруй Мухаммаду посредничество и превосходство)",
    "🌙 Витр намаз": "اللَّهُمَّ إِنَّا نَسْأَلُكَ الْهُدَى وَالتُّقَى وَالْعَفَافَ وَالْغِنَى\n«Аллахумма инна нас'алюка аль-худа ва-т-тақа ва-ль-'афафа ва-ль-гина»\n(О Аллах, поистине мы просим Тебя о прямом пути, богобоязненности, целомудрии и достатке)",
...
MAIN_KB = ReplyKeyboardMarkup(keyboard=[
    ...
    [KeyboardButton(text="/dua"), KeyboardButton(text="/quran_duas")],
    [KeyboardButton(text="/quiz"), KeyboardButton(text="/daily")],
